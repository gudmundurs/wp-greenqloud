...
class GreenQloudS3 {
	 ...
	 *
	*/
	function GreenQloudS3($accessKeyId, $secretKey, $serviceUrl="http://s.greenqloud.com/") {
		global $wpdb;
		...
		$this->options = array();
		$this->options['cache_table'] = $wpdb->prefix . 'greenqloud_wordpress_cache';
	...
	*/   
	...
	/**
	 * setObjectACL -- sets objects access control policy to one of GreenQloud canned policies.
	 *
